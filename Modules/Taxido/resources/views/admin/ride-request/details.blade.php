                        ...
                        <div class="card-body pt-0">
                            <ul class="ride-details-list">
                                ...
                                <li>
                                    ...
                                    <span id="ride-fare">{{ $cs . number_format(round($rideRequest?->ride_fare, 2), 2) }}</span>
                                </li>
                                <li>
                                    ...
                                    <div class="personal h-custom-scrollbar">
                                        ...
                                        <ul class="personal-details-list">
                                            <li>
                                                ...
                                                <span id="rider-email">N/A</span>
                                            </li>

                                            <li>
                                                {{ __('taxido::static.rides.contact_number') }}:
                                                <span id="rider-phone">N/A</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
    ...
    db.collection('ride_requests').doc(rideRequestId)
        .onSnapshot((doc) => {
            if (doc.exists) {
                ...
                $('#ride-fare').text(`{{ $cs }}${Math.round(data?.ride_fare * 100) / 100 || 0}`);
