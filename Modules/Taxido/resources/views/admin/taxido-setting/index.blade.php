                            ...
                            <form method="POST" class="needs-validation user-add" id="taxidosettingsForm"
                                ...
                                <div class="tab-content w-100" id="v-pills-tabContent">
                                    ...
                                    <div class="tab-pane fade" id="Ads_Setting" role="tabpanel" aria-labelledby="v-pills-profile-tab" tabindex="0">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-md-5" for="activation[fleet_wallet]">{{ __('taxido::static.settings.fleet_wallet') }}
                                                <i class="ri-error-warning-line" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="custom-tooltip" data-bs-title="{{ __('taxido::static.settings.fleet_wallets') }}"></i>
                                            </label>
                                            <div class="col-md-7">
                                                <div class="editor-space">
                                                    <label class="switch">
                                                        @if (isset($taxidosettings['activation']['fleet_wallet']))
                                                            <input class="form-control" type="hidden" name="activation[fleet_wallet]" value="0">
                                                            <input class="form-check-input" type="checkbox" name="activation[fleet_wallet]" value="1" {{ $taxidosettings['activation']['fleet_wallet'] ? 'checked' : '' }}>
                                                        @else
                                                            <input class="form-control" type="hidden" name="activation[fleet_wallet]" value="0">
                                                            <input class="form-check-input" type="checkbox" name="activation[fleet_wallet]" value="1">
                                                        @endif
                                                        <span class="switch-state"></span>
                                                    </label>
                                                </div>
